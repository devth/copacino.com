	...
	*/
	...
	public class YouTubeLoader extends Sprite {
		...
		public function YouTubeLoader () {
			...
			if ( ExternalInterface.available ) ExternalInterface.addCallback( "playerStateUpdateHandler", playerStateUpdateHandler)
		}
		...
		public function create ():void{
			...
			//MonsterDebugger.trace(this, "trying to load the chromless player");
			addChild(_loader);
		}
		...
		*/
		protected function playerStateUpdateHandler (state:Number):void{
			//trace(this, "YouTubeLoader: playerStateUpdateHandler for "+state);
		...
		*/
		...
		private function ioErrorHandler(event:IOErrorEvent):void {
			...
			// tell the world
			// MonsterDebugger.trace(this, "YouTubeLoader: ioErrorHandler: "+event.text);
