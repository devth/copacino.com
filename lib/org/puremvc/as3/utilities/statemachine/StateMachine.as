...
package org.puremvc.as3.utilities.statemachine
{
	...
	public class StateMachine extends Mediator
	{
		...
		protected function transitionTo( nextState:State, data:Object=null ):void
		{
			...
			Utility.debugColor( this, 0xFF0000, "current state is " + currentState.name );
		...
		override public function handleNotification( note:INotification ):void
		{
			switch( note.getName() )
			{
				case ACTION:
					...
					{
						/*Utility.debugColor( this, 0x1e84e2, "newState:", newState, action, target );
						Utility.debugColor( this, 0x1e84e2, "currentState:",currentState.name );
						Utility.debugColor( this, 0x1e84e2, "current available transitions:" );
						for ( var k:String in currentState.transitions )
						{
							Utility.debugColor( this, 0x00FFFF, k, currentState.transitions[k] );
						}*/
					}
					break;
